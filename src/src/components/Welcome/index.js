...
<div className="suggested_container">
  ...
  <div className="col-sm-4 col-12 ">
         ...
         <div className="quickstart_container">
           ...
           <img src="https://res.cloudinary.com/cmp84378/image/upload/v1611226170/play_arrow_24px_urjjct.png" class="img3" alt="img"/>
       ...
       <div className="contact_container">
         ...
         <div className="signup">
          ...
          <Links to="/signin"><button type="button" class="btn btn"id="but7">Sign Up</button></Links>
         </div>
